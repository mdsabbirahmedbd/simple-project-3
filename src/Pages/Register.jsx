...
const Register = () => {
	// const {registeForm,gogleForm,githubForm} = useContext(authContext)
  ...
  return (
	...
	<form   className="space-y-6">
		...
		<div className="space-y-1 text-sm">
			...
			<input type="email" name="email" id="username" placeholder="Email" className="w-full px-4 py-3 rounded-md border bg-gray-900 text-gray-100 focus:border-violet-400" />
		</div>
		<div className="space-y-1 text-sm">
	...
	<div className="flex justify-center space-x-4">
		<button onClick={()=>gogleForm()} aria-label="Log in with Google" className="p-3 rounded-sm">
		...
		<button onClick={()=>githubForm()} aria-label="Log in with GitHub" className="p-3 rounded-sm">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
	...
	<p className="text-xs text-center sm:px-6 text-gray-400"> have an account plase ?
